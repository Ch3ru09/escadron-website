...
export default function MoreInfo() {
  return (
    <div class={styles["more-info"]}>
      ...
      <div class={styles["info-center"]}>
        <img src="/logo.png" class={styles["info-logo"]} />
        <div class={styles["info-center-container"]}>
          <div class={styles["info-donation"]}>
            <h3>AIDEZ-NOUS DANS NOTRE MISSION AUPRÈS DE LA JEUNESSE LOCALE</h3>
            <p>
              L'Escadron 811 La Prairie est un organisme de bienfaisance enregistré auprès de l'Agence du Revenu du
              Canada. À ce titre, un reçu de don peut être émis pour tout don admissible, lequel peut ensuite être
              utilisé lors de la production de la déclaration d'impôt sur le revenu du donateur.
            </p>
          ...
          <div class={styles["info-orgs"]}>
            ...
            <p>
              Grâce à la contribution, le soutien et l'appui de ces bienfaiteurs, l'Escadron 811 La Prairie peut
              réaliser son mandat auprès de la jeunesse, et ce depuis plus de 50 ans.
            </p>
      ...
      <div class={styles["info-links"]}>
        ...
        <ul>
          ...
          <li>
            <a href="//cadetsair.ca/fr/" target="_blank">
              La Ligue des cadets de l'air - Québec et Vallée de l'Outaouais
            </a>
          </li>
        </ul>
      </div>
